...
<div class="main home-page active tabs-con" id="home"> 
    ...
    <section class="slider-wrap">
      <div class="items">
        <div class="item">
          <img src="{{ asset('front/images/slide1.jpeg')}}" alt="slide1">
        </div>
        <div class="item">
          <img src="{{ asset('front/images/slide2.jpeg')}}" alt="slide2">
        </div>
        <div class="item">
          <img src="{{ asset('front/images/slide3.jpeg')}}" alt="slide3">
        </div>
        <div class="item">
          <img src="{{ asset('front/images/slide4.jpeg')}}" alt="slide3">
        </div>
      </div>
    </section>
    <!-- Ends Slider Section -->
    ...
    <section class="categories-wrap">
      <ul>
        <li>
          <a href="">
            <span class="icon"><img src="images/list-with-dots.svg" alt="list-with-dots"></span>
            <span>All Categories</span>
          </a>
        </li>
        <li>
          <a href="">
            <span class="icon"><img src="images/women-dress.svg" alt="women-dress"></span>
            <span>Women Clothing</span>
          </a>
        </li>
        <li>
          <a href="">
            <span class="icon"><img src="images/cotton-polo-shirt.svg" alt="cotton-polo-shirt"></span>
            <span>Men Clothing</span>
          </a>
        </li>
        <li>
          <a href="">
            <span class="icon"><img src="images/baby-boy.svg" alt="baby-boy"></span>
            <span>Baby & Kids</span>
          </a>
        </li>
        <li>
          <a href="">
            <span class="icon"><img src="images/running.svg" alt="running"></span>
            <span>Footwares</span>
          </a>
        </li>
        <li>
          <a href="">
            <span class="icon"><img src="images/football.svg" alt="football"></span>
            <span>Sports wear</span>
          </a>
        </li>
        <li>
          <a href="">
            <span class="icon"><img src="images/mobile-phone.svg" alt="mobile-phone"></span>
            <span>Phones & Accessories</span>
          </a>
        </li>
        <li>
          <a href="">
            <span class="icon"><img src="images/laptop.svg" alt="laptop"></span>
            <span>Computer & Office</span>
          </a>
        </li>
        <li>
          <a href="">
            <span class="icon"><img src="images/console.svg" alt="console"></span>
            <span>Gaming Consoles</span>
          </a>
        </li>
        <li>
          <a href="">
            <span class="icon"><img src="images/home.svg" alt="home"></span>
        ...
        <div class="product-grids">
          <div class="grid">
            <div class="single-product">
              ...
              <div class="product-img">
                <a href="javascript:void(0)"><img src="images/tp-img-1.jpg" alt="tp-img-1"></a>
              </div>
              <div class="product-text">
                <div class="prod-cat">Men</div>
                <div class="prod-name"><a href="">Maniac Solid Men's Round Neck Grey T-Shirt </a></div>
          ...
          <div class="grid">
            <div class="single-product">
              ...
              <div class="product-img">
                <a href="javascript:void(0)"><img src="images/tp-img-2.jpg" alt="tp-img-2"></a>
              </div>
              <div class="product-text">
                <div class="prod-cat">Men</div>
                <div class="prod-name"><a href="">Maniac Solid Men's Round Neck Grey T-Shirt </a></div>
          ...
          <div class="grid">
            <div class="single-product">
              ...
              <div class="product-img">
                <a href="javascript:void(0)"><img src="images/tp-img-3.jpg" alt="tp-img-3"></a>
              </div>
              <div class="product-text">
                <div class="prod-cat">Men</div>
                <div class="prod-name"><a href="">Maniac Solid Men's Round Neck Grey T-Shirt </a></div>
          ...
          <div class="grid">
            <div class="single-product">
              ...
              <div class="product-img">
                <a href="javascript:void(0)"><img src="images/tp-img-4.jpg" alt="tp-img-4"></a>
              </div>
              <div class="product-text">
                <div class="prod-cat">Men</div>
                <div class="prod-name"><a href="">Maniac Solid Men's Round Neck Grey T-Shirt </a></div>
          ...
          <div class="grid">
            <div class="single-product">
              ...
              <div class="product-img">
                <a href="javascript:void(0)"><img src="images/tp-img-5.jpg" alt="tp-img-5"></a>
              </div>
              <div class="product-text">
                <div class="prod-cat">Men</div>
                <div class="prod-name"><a href="">Maniac Solid Men's Round Neck Grey T-Shirt </a></div>
          ...
          <div class="grid">
            <div class="single-product">
              ...
              <div class="product-img">
                <a href="javascript:void(0)"><img src="images/tp-img-6.jpg" alt="tp-img-6"></a>
              </div>
              <div class="product-text">
                <div class="prod-cat">Men</div>
                <div class="prod-name"><a href="">Maniac Solid Men's Round Neck Grey T-Shirt </a></div>
          ...
          <div class="grid">
            <div class="single-product">
              ...
              <div class="product-img">
                <a href="javascript:void(0)"><img src="images/tp-img-7.jpg" alt="tp-img-7"></a>
              </div>
              <div class="product-text">
                <div class="prod-cat">Men</div>
                <div class="prod-name"><a href="">Maniac Solid Men's Round Neck Grey T-Shirt </a></div>
          ...
          <div class="grid">
            <div class="single-product">
              ...
              <div class="product-img">
                <a href="javascript:void(0)"><img src="images/tp-img-8.jpg" alt="tp-img-8"></a>
              </div>
              <div class="product-text">
                <div class="prod-cat">Men</div>
                <div class="prod-name"><a href="">Maniac Solid Men's Round Neck Grey T-Shirt </a></div>
          ...
          <div class="grid">
            <div class="single-product">
              ...
              <div class="product-img">
                <a href="javascript:void(0)"><img src="images/tp-img-9.jpg" alt="tp-img-9"></a>
              </div>
              <div class="product-text">
                <div class="prod-cat">Men</div>
                <div class="prod-name"><a href="">Maniac Solid Men's Round Neck Grey T-Shirt </a></div>
          ...
          <div class="grid">
            <div class="single-product">
              ...
              <div class="product-img">
                <a href="javascript:void(0)"><img src="images/tp-img-10.jpg" alt="tp-img-10"></a>
              </div>
              <div class="product-text">
                <div class="prod-cat">Men</div>
                <div class="prod-name"><a href="">Maniac Solid Men's Round Neck Grey T-Shirt </a></div>
          ...
          <div class="grid">
            <div class="single-product">
              ...
              <div class="product-img">
                <a href="javascript:void(0)"><img src="images/tp-img-11.jpg" alt="tp-img-11"></a>
              </div>
              <div class="product-text">
                <div class="prod-cat">Men</div>
                <div class="prod-name"><a href="">Maniac Solid Men's Round Neck Grey T-Shirt </a></div>
          ...
          <div class="grid">
            <div class="single-product">
              ...
              <div class="product-img">
                <a href="javascript:void(0)"><img src="images/tp-img-12.jpg" alt="tp-img-12"></a>
              </div>
              <div class="product-text">
                <div class="prod-cat">Men</div>
                <div class="prod-name"><a href="">Maniac Solid Men's Round Neck Grey T-Shirt </a></div>
            ...
            <div id="electronics" class="tab-pane active">
              <div class="product-tile">
                <div class="grid grid-1">
                  ...
                  <div class="product-img">
                    <img src="images/electronic-tile-1.jpg" alt="electronic-tile-1">
                  </div>
                ...
                <div class="grid grid-2">
                  ...
                  <div class="product-img">
                    <img src="images/electronic-tile-2.jpg" alt="electronic-tile-2">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-3">
                  ...
                  <div class="product-img">
                    <img src="images/electronic-tile-3.jpg" alt="electronic-tile-3">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-4">
                  ...
                  <div class="product-img">
                    <img src="images/electronic-tile-4.jpg" alt="electronic-tile-4">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-5">
                  ...
                  <div class="product-img">
                    <img src="images/electronic-tile-5.jpg" alt="electronic-tile-5">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-6">
                  ...
                  <div class="product-img">
                    <img src="images/electronic-tile-6.jpg" alt="electronic-tile-6">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-7">
                  ...
                  <div class="product-img">
                    <img src="images/electronic-tile-7.jpg" alt="electronic-tile-7">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
            ...
            <div id="men" class="tab-pane">
              <div class="product-tile">
                <div class="grid grid-1">
                  ...
                  <div class="product-img">
                    <img src="images/men-tile-1.jpg" alt="men-tile-1">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-2">
                  ...
                  <div class="product-img">
                    <img src="images/men-tile-2.jpg" alt="men-tile-2">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-3">
                  ...
                  <div class="product-img">
                    <img src="images/men-tile-3.jpg" alt="men-tile-3">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-4">
                  ...
                  <div class="product-img">
                    <img src="images/men-tile-4.jpg" alt="men-tile-4">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-5">
                  ...
                  <div class="product-img">
                    <img src="images/men-tile-5.jpg" alt="men-tile-5">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-6">
                  ...
                  <div class="product-img">
                    <img src="images/men-tile-6.jpg" alt="men-tile-6">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-7">
                  ...
                  <div class="product-img">
                    <img src="images/men-tile-7.jpg" alt="men-tile-7">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                    <div class="product-title"><a href="javascript:void(0)">Asus ROG</a></div>
            ...
            <div id="women" class="tab-pane">
              <div class="product-tile">
                <div class="grid grid-1">
                  ...
                  <div class="product-img">
                    <img src="images/women-tile-1.jpg" alt="women-tile-1">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-2">
                  ...
                  <div class="product-img">
                    <img src="images/women-tile-2.jpg" alt="women-tile-2">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-3">
                  ...
                  <div class="product-img">
                    <img src="images/women-tile-3.jpg" alt="women-tile-3">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-4">
                  ...
                  <div class="product-img">
                    <img src="images/women-tile-4.jpg" alt="women-tile-4">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-5">
                  ...
                  <div class="product-img">
                    <img src="images/women-tile-5.jpg" alt="women-tile-5">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-6">
                  ...
                  <div class="product-img">
                    <img src="images/women-tile-6.jpg" alt="women-tile-6">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-7">
                  ...
                  <div class="product-img">
                    <img src="images/women-tile-7.jpg" alt="women-tile-7">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
            ...
            <div id="footwears" class="tab-pane">
              <div class="product-tile">
                <div class="grid grid-1">
                  ...
                  <div class="product-img">
                    <img src="images/footwear-tile-1.jpg" alt="footwear-tile-1">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-2">
                  ...
                  <div class="product-img">
                    <img src="images/footwear-tile-2.jpg" alt="footwear-tile-2">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-3">
                  ...
                  <div class="product-img">
                    <img src="images/footwear-tile-3.jpg" alt="footwear-tile-3">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-4">
                  ...
                  <div class="product-img">
                    <img src="images/footwear-tile-4.jpg" alt="footwear-tile-4">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-5">
                  ...
                  <div class="product-img">
                    <img src="images/footwear-tile-5.jpg" alt="footwear-tile-5">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-6">
                  ...
                  <div class="product-img">
                    <img src="images/footwear-tile-6.jpg" alt="footwear-tile-6">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-7">
                  ...
                  <div class="product-img">
                    <img src="images/footwear-tile-7.jpg" alt="footwear-tile-7">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
            ...
            <div id="baby-kids" class="tab-pane">
              <div class="product-tile">
                <div class="grid grid-1">
                  ...
                  <div class="product-img">
                    <img src="images/baby-tile-1.jpg" alt="baby-tile-1">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-2">
                  ...
                  <div class="product-img">
                    <img src="images/baby-tile-2.jpg" alt="baby-tile-2">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-3">
                  ...
                  <div class="product-img">
                    <img src="images/baby-tile-3.jpg" alt="baby-tile-3">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-4">
                  ...
                  <div class="product-img">
                    <img src="images/baby-tile-4.jpg" alt="baby-tile-4">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-5">
                  ...
                  <div class="product-img">
                    <img src="images/baby-tile-5.jpg" alt="baby-tile-5">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-6">
                  ...
                  <div class="product-img">
                    <img src="images/baby-tile-6.jpg" alt="baby-tile-6">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
                ...
                <div class="grid grid-7">
                  ...
                  <div class="product-img">
                    <img src="images/baby-tile-7.jpg" alt="baby-tile-7">
                  </div>
                  <div class="content-overlay"></div>
                  <div class="content-details">
    ...
    <section class="featured-product">
      <div class="custom-container">
        <div class="banner-wrap">
          <img src="images/featured-product-banner.jpg" alt="featured-product-banner">
        </div>
          ...
          <div class="row">
            <div class="col-xl-4 col-lg-6 col-md-6">
              <div class="horizontal-product">
                ...
                <div class="product-img">
                  <a href="javascript:void(0)"><img src="images/fp-1.jpg"></a>
                </div>
                <div class="product-text">
                  <div class="prod-cat">Men</div>
                  <div class="prod-name"><a href="">Maniac Solid Men's Round Neck Grey T-Shirt </a></div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
              <div class="horizontal-product">
                ...
                <div class="product-img">
                  <a href="javascript:void(0)"><img src="images/fp-2.jpg"></a>
                </div>
                <div class="product-text">
                  <div class="prod-cat">Men</div>
                  <div class="prod-name"><a href="">Maniac Solid Men's Round Neck Grey T-Shirt </a></div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
              <div class="horizontal-product">
                ...
                <div class="product-img">
                  <a href="javascript:void(0)"><img src="images/fp-3.jpg"></a>
                </div>
                <div class="product-text">
                  <div class="prod-cat">Men</div>
                  <div class="prod-name"><a href="">Maniac Solid Men's Round Neck Grey T-Shirt </a></div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
              <div class="horizontal-product">
                ...
                <div class="product-img">
                  <a href="javascript:void(0)"><img src="images/fp-4.jpg"></a>
                </div>
                <div class="product-text">
                  <div class="prod-cat">Men</div>
                  <div class="prod-name"><a href="">Maniac Solid Men's Round Neck Grey T-Shirt </a></div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
              <div class="horizontal-product">
                ...
                <div class="product-img">
                  <a href="javascript:void(0)"><img src="images/fp-5.jpg"></a>
                </div>
                <div class="product-text">
                  <div class="prod-cat">Men</div>
                  <div class="prod-name"><a href="">Maniac Solid Men's Round Neck Grey T-Shirt </a></div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
              <div class="horizontal-product">
                ...
                <div class="product-img">
                  <a href="javascript:void(0)"><img src="images/fp-6.jpg"></a>
                </div>
                <div class="product-text">
                  <div class="prod-cat">Men</div>
                  <div class="prod-name"><a href="">Maniac Solid Men's Round Neck Grey T-Shirt </a></div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="banner-image">
                <a href="javascript:void(0)">
                  <img src="images/banner-fp-2.jpg" alt="banner-fp-1">
                </a>
              </div>
            </div>
            <div class="col-md-6">
              <div class="banner-image">
                <a href="javascript:void(0)">
                  <img src="images/banner-fp-1.jpg" alt="banner-fp-2">
                </a>
              </div>
            </div>
          </div>
      ...
      <div class="custom-container">
        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-lg-6 col-sm-6">
            <div class="top-bundle">
              <div class="cat-img">
                <img src="images/game-consoles.jpg">
              </div>
              <div class="cat-title">
