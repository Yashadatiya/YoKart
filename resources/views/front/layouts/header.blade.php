        ...
        <ul class="main-menu">
          <li class="menu-child">
            ...
            <div class="subnav">
              <ul class="sublinks">
                ...
                <li>
                  <a href="/mobiles">Gaming Consoles</a>
                  <ul class="links">
          ...
          <li class="menu-child">
            ...
            <div class="subnav">
              <ul class="sublinks">
                <li>
                  <a href="/mobiles">Jeans & Bottom Wear</a>
                </li>
                <li>
                  <a href="/mobiles">Tops and T-shirts</a>
                </li>
              </ul>
            </div>
          </li>
