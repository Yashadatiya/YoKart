   ...
   <section class="sub-cat">
      <div class="custom-container">
         <div class="sub-cat-inner">
            <h2 class="section-title">Sub Category from Main Category</h2>
         ...
         <div class="all-brand-inner">
            ...
            <ul class="brand-img">
              @foreach($all_brand as $brn_key => $brn_value)
               <li>
                <center><a href="javascript:void(0)"><img class="brand-image" src="@if(!empty($brn_value->logo)) @if(file_exists(public_path('front/brand/'.$brn_value->logo))) {{ asset('public/front/brand/'.$brn_value->logo)}} @else {{ asset('public/front/brand/default_brand_image.png')}} @endif @else {{ asset('public/front/brand/default_brand_image.png')}}  @endif" alt="{{ $brn_value->name }}"></a></center>
