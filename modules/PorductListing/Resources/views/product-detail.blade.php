         ...
         <div class="custom-container">
            <div class="row">
               ...
               <div class="col-lg-2 col-md-4 col-sm-12">
                  <div class="footer-group">
                     ...
                     <ul class="footer-links">
                        <li><i class="fa fa-phone-volume"></i><a href=""> dummy </a></li>
               ...
               <div class="col-lg-2 col-md-4 col-sm-12">
                  <div class="footer-group">
                     ...
                     <div class="store-button">
                        <a class="btn" href="javascript:void(0)"><img src="images/store-icn.png">Open a Store</a>
                     </div>
                  </div>
               </div>
               <div class="col-lg-4 col-md-8 col-sm-12">
                  <div class="footer-group">
                     ...
                     <ul class="contact-info">
                        <li><img src="images/icn-mobile.png" alt="icn-mobile">(180) 027-2172</li>
                        <li><a href="mailto:yokart@dummyid.com"><img src="images/icn-email.png" alt="icn-email">yokart@dummyid.com</a></li>
                     </ul>
                  </div>
               </div>
            </div>
            <div class="row bottom-footer">
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="payment">
                     <img src="images/payment.png" alt="Payment Options">  <img src="images/payment.png" alt="Payment Options">  <img src="images/payment.png" alt="Payment Options">  <img src="images/payment.png" alt="Payment Options">  <img src="images/payment.png" alt="Payment Options">  <img src="images/payment.png" alt="Payment Options">  <img src="images/payment.png" alt="Payment Options">  <img src="images/payment.png" alt="Payment Options">
                  </div>
               </div>
            </div>
         </div>
