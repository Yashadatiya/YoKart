   ...
   <div class="product-detail-section">
      ...
      <div class="product-detail-right">
         ...
         <li>
            ...
            <span>Voucher</span> <div class="product-detail-content-right"><a href="">fgh100</a><a href="">zvjn200</a> <a href="">ert400</a><a href="" class="more">More<i class="fa fa-angle-right"></i></a></div>

         </li>

    <li>

      <span>Free Shpping</span> <div class="product-detail-content-right"><p>Rp. 15,000 when spent Rp.250</p><a href="" class="more">More<i class="fa fa-angle-right"></i></a>
...
<select>
   ...
   <option value="Dki Jakarta">Dki Jakarta</option>
    ...
    <li>
      ...
      <span>Size</span> <div class="product-detail-content-right">
    ...
    <li>
            ...
            <div class="product-detail-content-right">
               ...
               <ul class="color-check">
                  @foreach($ex_value->images_new as $img_key => $img_value)
                     <li><a href=""><img src="@if(!empty($img_value))@if(file_exists(public_path('front/product/'.$img_value))) {{ asset('public/front/product/'.$img_value)}} @else {{ asset('public/front/product/default_product_image.png')}} @endif" alt="{{ $img_value }} @else {{ asset('public/front/product/default_product_image.png')}} @endif"></a></li>
                  @endforeach
               </ul>
            </div>
         @endforeach 
      ...
      <li>
         ...
         <div class="product-detail-content-right">
            ...
            <div class="qty-more"><div class="minus-qty"><a href=""> - </a></div><div class="qty1">

               <a href=""> 1 </a></div> <div class="plus-qty"><a href=""> + </a></div> <span>Left 3 Pcs</span>
      ...
      <li>
         ...
         <span>&nbsp;</span> <div class="product-detail-content-right">

         <button><i class="fa fa-cart-plus" aria-hidden="true"></i>Buy Now</button>

         <button><i class="fa fa-shopping-cart"></i>Add to cart</button></div>
