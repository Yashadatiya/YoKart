                ...
                @foreach($all_category as $main_key => $main_value)
                  <div class="item grid">
                     <div class="product-img">
                        ...
                        <img class="category-image" src="@if(!empty($main_value->logo))@if(file_exists(public_path('front/category/'.$main_value->logo))) {{ asset('front/category/'.$main_value->logo)}} @else {{ asset('front/category/cat-default.jpg')}} @endif @else {{ asset('front/category/cat-default.jpg')}} @endif" alt="{{ $main_value->name}}">
                        </a>
                     </div>
      ...
      <div class="custom-container">
         <div class="all-brand-inner">
            ...
            <ul class="brand-img">
               ...
               <li>
                <center><a data-id="{{ $brn_value->brand_id }}" onclick="brandsproduct(this)" style="cursor: pointer"><img style="width:100%;padding: 5%;" src="@if(!empty($brn_value->logo)) @if(file_exists(public_path('front/brand/'.$brn_value->logo))) {{ asset('front/brand/'.$brn_value->logo)}} @else {{ asset('front/brand/default_brand_image.png')}} @endif @else {{ asset('front/brand/default_brand_image.png')}}  @endif" alt="{{ $brn_value->name }}"></a></center>
               </li>
              @endforeach 
            </ul>
         </div>
               ...
               <div class="product-grids">
                  ...
                  <div class="grid">
                     <div class="single-product">
                        ...
                        <div class="product-img">
                           <a href="{{ route('product',['product'=>$product->p_nm]) }}"><img class="product-min-height product-data" src="@if(file_exists(public_path('front/product/'.$product->main_image))) {{ asset('front/product/'.$product->main_image)}} @else {{ asset('front/product/tp-img-1.jpg')}} @endif" alt="{{ $product->main_image }}" ></a>
                        </div>
                        <div class="product-text">
